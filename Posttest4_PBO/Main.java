...
class ProdukRaket extends Produk {
    ...
    @Override
    public String toString() {
        return super.toString() + ", Tipe Senar: " + tipeSenar;
    }
}
...
class ProdukLokal extends Produk {
    ...
    @Override
    public String toString() {
        return super.toString() + ", Daerah Asal: " + daerahAsal;
    }
}
...
class TokoBadminton {
    ...
    public void tampilkanProduk() {
        if (produk.isEmpty()) {
            ...
            for (Produk p : produk) {
                System.out.println(p); // Memanggil toString() untuk setiap objek produk
            }
        }
    }
